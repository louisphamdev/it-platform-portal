#!/bin/bash
# PostgreSQL initialization script for Staging environment
# This script runs on first startup of postgres-staging container
...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    ...
    GRANT ALL PRIVILEGES ON DATABASE "itaudit_staging" TO app_user;
